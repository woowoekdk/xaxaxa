...
@sython1.on(events.NewMessage(outgoing=False, pattern='/sy'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply("""**/point1 
يبلش تجميع نقاط بوت المليار
/point2
يبلش تجميع نقاط بوت الجوكر
/point3
يبلش تجميع بوت تمويل العقاب
/point4
يبلش تجميع بوت العرب 
/TEST 
يسوي فحص للارقام الشغال عليه السورس

/lpoint 
يغادر كل القنوات والمجموعات

/transfer 
من ترسله تضهر قائمة ثانيه تحتوي على اوامر تحويل نقاط
/infoacc
من ترسلة تنفتح قائمة ثانيه تظهر بيه اوامر اضهار معلومات الحساب ببوت تمويل معين
/voice + يوزر القناة بدون @ + n موقع الرسالة + n طرح موقع الرسالة من 1**""")
